...
# تعطيل تحذيرات SSL لضمان استقرار الاتصال
urllib3.disable_warnings(urllib3.exceptions.InsecureRequestWarning)

# --- إعدادات البوت والـ API ---
TOKEN = "8642055297:AAGM3ztTqcDL94__XQsmYhuMbfjgd5opL-4"
bot = telebot.TeleBot(TOKEN)

# المفتاح الذي استخرجته أنت (تأكد من تحديثه إذا تغير في فريدا)
DYNAMIC_SEED = "dQqkLIEQXc9TBIkc"
URL = "https://apinb.numberbooksocial.com/Nbchat/search"

# الهيدرز الأصلية (تم الإبقاء عليها كما استخرجتها لضمان قبول السيرفر للجلسة)
HEADERS = {
...
print("[*] SIN SYSTEM IS RUNNING ON PARROT OS...")
